                ...
                <div className='flex flex-col lg:flex-row items-start lg:justify-between mb-14'>
                    <div className='mb-10 lg:mb-0'>
                        <div className='flex items-center mb-3'>
                            <p data-aos="fade-up" className='text-xl font-bold'>+7 (000) 000-00-00</p>
                            <Link data-aos="fade-up" to='/telegram'><img className='w-[60px] lg:mr-5' src={Telegram} alt="" /></Link>
                            <Link data-aos="fade-up" to='/whatsapp'><img className='w-[55px] lg:mr-5' src={wh} alt="" /></Link>
                            <Link data-aos="fade-up" to='/yandex'><img className='w-[60px]' src={yandex} alt="" /></Link>
                        </div>
                        <div>
                            <p data-aos="fade-up" className='text-black text-[20px] mb-3'> Пн—Пт с 11:00 до 21:00</p>
                            <p data-aos="fade-up" className='text-black text-[20px] mb-5'>Сб—Вс Выходной</p>
                            <p data-aos="fade-up" className='text-black text-[20px] mb-3'> г. Москва, ул. Ленинская, дом 0, корп 0, офис 0</p>
                            <p data-aos="fade-up" className='text-blue-500 text-[20px] mb-3'>mail@company.ru</p>
                            <p data-aos="fade-up" className='text-black text-[20px] mb-3'>ИНН 000000000 ОГРН 000000000</p>
                        </div>
                    </div>
                    <div>
                        <iframe data-aos="fade-up" className='w-full sm:w-[600px] lg:w-[785px] h-[400px]' frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=635&amp;height=484&amp;hl=en&amp;q=Maskva%20Moscow+()&amp;t=k&amp;z=9&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href='https://google-map-generator.com/'>Maps Generator</a>
                    </div>
                </div>
                <div>
