  ...
  return (
    <div className='bg-[#fafafa]'>
      ...
      <div className='w-full max-w-base px-8 mx-auto py-5 '>
        ...
        <h4 className='text-[35px] font-bold mb-5'>Этапы работ</h4>
        <p className='text-[20px] text-[#6b6a6a] font-medium mb-7 '>С нами выгодно строить</p>
        <ul className='grid grid-cols-2 grid-rows-3 gap-10 pb-16'>
