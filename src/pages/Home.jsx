    ...
    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3 gap-10">
      <li>
        <Link to={'/ToshUy'}>
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_1} alt="" />
      ...
      <li>
        <Link to={'/BloklanganUylar'}>
          <div className='bg-white pb-5'>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_2} alt="" />
      ...
      <li>
        <Link to={'/YarimYogoch'} >
          <div className='bg-white pb-5'>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_3} alt="" />
      ...
      <li>
        <Link to={'/RamkaliUy'}>
          <div className='bg-white pb-5'>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_4} alt="" />
      ...
      <li>
        <Link to={'/YogochdanYasalgan'}>
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_5} alt="" />
      ...
      <li>
        <Link to={'/YogochUy'}>
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_6} alt="" />
      ...
      <li>
        <Link to={'/Vannalar'} >
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_10} alt="" />
      ...
      <li>
        <Link to={'/Gazebos'} >
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_8} alt="" />
      ...
      <li>
        <Link to={'/Garaj'}>
          <div className='bg-white pb-5 '>
            <img className='rounded-lg object-cover transform transition-transform duration-500 hover:scale-105' src={Qulay_9} alt="" />
...
<div className='bg-[#fafafa]'>
  <div className='w-full max-w-base px-5 mx-auto pb-10'>
        ...
        return (
          <li key={project.id}>
            <Link to={`/portfolio/${project.title}`}  >
              <div className='bg-white pb-5 '>
                <img className='inline-block h-[300px] w-[400px] rounded-lg object-cover transform transition-transform duration-500 hover:scale-105 ' src={project.img} alt={project.title} />
                <h3 className='py-3 px-5 text-[25px] hover:text-[#6cd16c] duration-500 '>{project.title}</h3>
                <p>{project.text}</p>
              </div>
            </Link>
          </li>
...
<div className='bg-img bg-no-repeat mb-28 bg-cover'>
        ...
        <ul>
          ...
          <li>
            <div className='flex items-center mb-5'>
              ...
              <p className='text-[15px] font-medium text-[#868686]'><Link to={'/FoydalanishSharti'}>Ознакомлен(а) с </Link> <u>пользовательским соглашением * </u></p>
            </div>
          </li>
          <li>
            <button className='bg-[#79c701] py-6 rounded-lg px-7 text-white text-[20px] font-semibold'>Заказать звонок</button>
          </li>
        </ul>
      </div>
    </di>
