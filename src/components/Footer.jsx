  ...
  return (
    <div className='bg-[#1f1e1e]'>
      <div className='w-full max-w-base pt-20 mx-auto px-5'>
        <ul className='w-full max-w-base mx-auto pb-16 px-5 flex flex-col md:flex-row items-start justify-between'>
          ...
          <li className='mb-10 md:mb-0'>
            ...
            <Link className='text-white text-[16px] md:text-[18px]'>login@domain.ru</Link>
        ...
        <div onClick={closeModal} className='fixed inset-0 bg-black bg-opacity-50 z-20 pt-10' id='overlay'>
          <div className='max-w-[470px] bg-white w-full mx-auto min-h-4/5 bg-bgModal rounded-3xl relative'>
            ...
            <div className='px-5 md:px-10 py-12'>
              ...
              <form>
                <input className='text-black w-full text-[16px] px-5 py-3 mb-5 border-[1px] rounded-md hover:border-green-500 duration-500' type="text" placeholder="Ваше имя" />
                <textarea className='text-black w-full text-[16px] px-5 py-3 mb-5 border-[1px] rounded-md hover:border-green-500 duration-500' name="Message" placeholder="Комментарий"></textarea>
                <input className='text-black w-full text-[16px] px-5 py-3 mb-5 border-[1px] rounded-md hover:border-green-500 duration-500' type="tel" placeholder="+7 (___) ___ __ __" />
              </form>
              <div className='flex items-center mb-7'>
                <input type="checkbox" className='mr-3 h-5 w-5 rounded-lg border-none' />
                <Link to={'/FoydalanishSharti'} className='text-[15px] text-black duration-500'>
                  Я согласен(на) на обработку <u className='text-black'>персональных данных *</u>
                </Link>
              </div>
              <div className="flex justify-center">
                <button className='w-full py-5 bg-[#79c701] text-[18px] text-white rounded-md'>Отправить</button>
              </div>
            </div>
          </div>
        </div>
