...
const HomeHero = () => {
  ...
  const CustomNextArrow = ({ onClick }) => (
    <div
      className="w-16 h-16 bg-gray-600 opacity-70 rounded-2xl absolute top-1/2 right-5 flex items-center justify-center z-10 hover:bg-[#63b700] cursor-pointer"
      onClick={onClick}
    >
  ...
  const CustomPrevArrow = ({ onClick }) => (
    <div
      className="w-16 h-16 bg-gray-600 opacity-70 rounded-2xl absolute top-1/2 right-24 flex items-center justify-center z-10 hover:bg-[#63b700] cursor-pointer"
      onClick={onClick}
    >
